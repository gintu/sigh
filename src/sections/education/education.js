...
import classes from '../work/work.module.scss'
  ...
  return (
    <div className={classes.Work}>
        ...
        <div className={classes.Card}>
            ...
            <p className={classes.Title}>Rajiv Gandhi Institute of Technology, Kottayam</p>
            <p className={classes.SubTitle}>B.Tech in Computer Science and Engineering</p>
            <ul className={classes.Details}>
               <li>Served as the president of Computer Science Association</li>
               <li>Conducted and Coordinated many events</li>
